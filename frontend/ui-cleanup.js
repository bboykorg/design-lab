...
(function () {
  ...
  function clean() {
    ...
    replaceExact(
      'Возьми один из 98 шаблонов — или просто опиши идею в строке на главном экране и начни с чистого холста.',
      'Выбери один из 98 шаблонов или открой конструктор и создай сайт с нуля.'
    );
    replaceExact(
      'ИИ переписывает дизайн на глазах в правом окне. Понравилось — скачай готовый HTML одним файлом.',
      'Проверь результат в окне предпросмотра, внеси правки и скачай готовый HTML одним файлом.'
    );
